...
class DlTools:
    ...
    def data_preprocessing(self, dataset, features, label, label_encoder_list, one_hot_encoded_list):
    ...
    def model_structure(self, model, x, y, hidden_layers, neurons_hidden_layer, hidden_layer_af, output_layer_af):
...
class DlLogger:
    ...
    def logger_metrics(self, file_name, dataset, history, hidden_layers, neurons_per_hidden_layer, hidden_layer_af, output_layer_af,
                       optimizer, loss, metrics, batch_size, epochs, verbose):
